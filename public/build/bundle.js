...
var app = (function () {
    ...
    ***************************************************************************** */
    ...
    /* src/view/App.svelte generated by Svelte v3.31.2 */

    function add_css() {
    	var style = element("style");
    	style.id = "svelte-xoydy4-style";
    	style.textContent = "line.axis.svelte-xoydy4{stroke:#cecece;stroke-width:1;stroke-dasharray:4}circle.svelte-xoydy4{fill:white;stroke:black}circle.svelte-xoydy4:hover{fill:grey}circle.selected.svelte-xoydy4{fill:black}circle.selected.svelte-xoydy4:hover{fill:black}";
    ...
    // (94:8) {#each context.circles as circle, circleIndex}
    function create_each_block(ctx) {
    	...
    	function func() {
    		return /*func*/ ctx[7](/*circleIndex*/ ctx[15]);
    	}

    	function click_handler() {
    		return /*click_handler*/ ctx[8](/*circleIndex*/ ctx[15]);
    	}

    	return {
    		c() {
    			circle = svg_element("circle");
    			attr(circle, "cx", circle_cx_value = /*circle*/ ctx[13].x);
    			attr(circle, "cy", circle_cy_value = /*circle*/ ctx[13].y);
    			attr(circle, "r", circle_r_value = /*circle*/ ctx[13].radius);
    			attr(circle, "class", circle_class_value = "" + (null_to_empty(func) + " svelte-xoydy4"));
    		},
    		m(target, anchor) {
    		...
    		p(new_ctx, dirty) {
    			...
    			if (dirty & /*context*/ 4 && circle_cx_value !== (circle_cx_value = /*circle*/ ctx[13].x)) {
    				attr(circle, "cx", circle_cx_value);
    			}

    			if (dirty & /*context*/ 4 && circle_cy_value !== (circle_cy_value = /*circle*/ ctx[13].y)) {
    				attr(circle, "cy", circle_cy_value);
    			}

    			if (dirty & /*context*/ 4 && circle_r_value !== (circle_r_value = /*circle*/ ctx[13].radius)) {
    				attr(circle, "r", circle_r_value);
    			}

    			if (dirty & /*context*/ 4 && circle_class_value !== (circle_class_value = "" + (null_to_empty(func) + " svelte-xoydy4"))) {
    ...
    // (105:4) {#if current.value === 'editing'}
    function create_if_block(ctx) {
    	...
    	return {
    		...
    		m(target, anchor) {
    			...
    			set_input_value(input, /*radius*/ ctx[3]);
    		...
    		p(ctx, dirty) {
    			if (dirty & /*radius*/ 8) set_data(t1, /*radius*/ ctx[3]);
    ...
    function create_fragment(ctx) {
    	...
    	let br1;
    	let t3;
    	let t4_value = /*context*/ ctx[2].count + "";
    	let t4;
    	let t5;
    	let br2;
    	let t6;
    	let t7_value = JSON.stringify(/*context*/ ctx[2]) + "";
    	let t7;
    	let mounted;
    	let dispose;
    	let each_value = /*context*/ ctx[2].circles;
    	let each_blocks = [];
    	...
    	let if_block = /*current*/ ctx[1].value === "editing" && create_if_block(ctx);
    	...
    	return {
    		c() {
    			...
    			attr(line0, "x2", "0");
    			attr(line0, "y2", "100");
    			attr(line0, "class", "axis svelte-xoydy4");
    			attr(line1, "x1", "-100");
    			attr(line1, "y1", "0");
    			attr(line1, "x2", "100");
    			attr(line1, "y2", "0");
    			attr(line1, "class", "axis svelte-xoydy4");
    			attr(svg_1, "width", "500");
    			attr(svg_1, "height", "500");
    			attr(svg_1, "viewBox", "-100 -100 200 200");
    		},
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen(svg_1, "click", /*clickHandler*/ ctx[6]);
    				mounted = true;
    			}
    		},
    		p(ctx, [dirty]) {
    			if (dirty & /*context, toggleService*/ 36) {
    				each_value = /*context*/ ctx[2].circles;
    				let i;
    			...
    			if (/*current*/ ctx[1].value === "editing") {
    				if (if_block) {
    			...
    			if (dirty & /*context*/ 4 && t4_value !== (t4_value = /*context*/ ctx[2].count + "")) set_data(t4, t4_value);
    			if (dirty & /*context*/ 4 && t7_value !== (t7_value = JSON.stringify(/*context*/ ctx[2]) + "")) set_data(t7, t7_value);
    		},
    		i: noop,
    		o: noop,
    		d(detaching) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const toggleService = interpret(toggleMachine).onTransition(state => {
    		$$invalidate(1, current = JSON.parse(JSON.stringify(state)));
    		$$invalidate(2, context = JSON.parse(JSON.stringify(state)).context);
    		console.log(context, current.value, current);
    	}).start(); //console.log(current.context) // granular context state 
    	...
    	const clickHandler = event => {
    		...
    		toggleService.send({ type: "LOL", x, y, count: Math.random() });
    	};

    	const func = circleIndex => circleIndex === context.selectedCircleIndex
    	? "selected"
    	: "";

    	const click_handler = circleIndex => toggleService.send("EDIT", { selectedCircleIndex: circleIndex });
    	...
    	const click_handler_1 = () => {
    		...
    		toggleService.send("CHANGE_CIRCLE_RADIUS", { radius: radiusInput.value });
    	};
    ...
    class App extends SvelteComponent {
    	constructor(options) {
    		super();
    		if (!document.getElementById("svelte-xoydy4-style")) add_css();
